    ...
    <div class="card shadow p-4 d-flex flex-column justify-content-center align-items-center" style="width: 410px; height: 500px; border-radius: 20px; font-family: Montserrat, sans-serif; border: none; z-index: 2; position: relative;">
            ...
            <div class="phonenumber-form">
                <input type="text" class="form-control" style="margin-bottom:20px;  width: 283px; height: 32px; border-color: #43D2B1; border-radius: 5px; background-color: #F2F2F2; font-size: 12px" placeholder="Phone Number" required>
                    ...
                    <div class="d-flex justify-content-end" style="width: 283px; margin-top: 5px;">
                        <button type="submit" class="btn btn-primary-register" style="width: 106px; height: 32px; background-color: #44D7B5; border: none; border-radius: 5px; font-size: 12px; font-weight: bold; color: #FFFFFF;">Register</button>
                    </div>  
                </form>
            </div>
        </div>
        ...
        <div class="segitigacontainer">
            ...
            <div class="content-section">
                <h2 class="text-center mb-4" style="margin-top: -45px; margin-bottom: 100px; color: #43D3B2; font-weight: bold; font-size: 25px">Sudah punya akun?</h2>
                ...
                <button type="submit" class="btn btn-primary-login" style="width: 106px; height: 32px; background-color: black;  border-color:#44D7B5; border-radius: 5px; font-size: 12px; font-weight: bold; color: #FFFFFF;">Login</button>
                </div>
