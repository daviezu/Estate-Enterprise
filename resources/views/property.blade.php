                ...
                <div class="col-md-4 col-sm-6 mb-4">
                    <div class="card shadow-sm h-100" style="border-radius: 20px; border: none;">
                        <a href="{{ route('agent.detail', $p->PropertyToAgent->user_id) }}" class="agent-picture d-block">
                            <img src="{{ $p->PropertyToAgent->picture_path }}" alt="" class="w-100 h-100 "
                                style="object-fit: cover; border-radius:50%;">
                        </a>
                        <div class="rounded-sm" style="height:195px; width:100%">
                            <img class="w-100 h-100 rounded" src="{{ asset(json_decode($p->picture_path, true)[0]) }}"
                                style="background-position:center; object-fit:cover;" alt="property1">
                        </div>
                        <div class="d-flex flex-column p-3 gap-1 h-100">
                            <div class="d-flex flex-column flex-grow-1 text-truncate">
                                ...
                                <p class="text-secondary mb-1"
                                    style="font-weight: 600; font-family: Montserrat, sans-serif; font-size: 16px;">
                                    {{ $p->property_owner }}
                                </p>
                            ...
                            <div class="text-end">
                                <a href="{{ route('property.detail', $p->slug) }}" class="btn btn-lg text-light"
                                    style="background-color:#44D7B5">
                                    Lihat Detail
                                </a>
                            </div>
                        </div>
