        ...
        <div class="row">
            ...
            <div class="col-md-4 mb-4">
                <div class="card" style="width: 26.25rem; border: none; border-radius: 20px">
                    ...
                    <div class="card-body">
                        <h5 class="card-price"
                            style="font-weight: bold; font-family: Montserrat, sans-serif; font-size: 24px">Rp 1 M - 1,5 M
                        </h5>
                        <h2 class="card-tittle"
                            style="font-weight: 600; font-family: Montserrat, sans-serif; font-size: 20px">Green Valley
                            Residence</h2>
                        <h3 class="card-text"
                            style="font-weight: 600; font-family: Montserrat, sans-serif; font-size: 12px">By Ibu Rina
                            Setyowati</h3>
                        <p class="card-text" style="font-family: Montserrat, sans-serif; font-size: 12px; opacity: 0.7;">
                            Sawangan, Kota Depok</p>
                        <p class="card-text" style="font-family: Montserrat, sans-serif; font-size: 12px;">2-4 KT, LT 90-200
                            m², LB 80-150 m²</p>
                        <p class="card-text"
                            style="font-family: Montserrat, sans-serif; font-size: 12px; opacity: 0.7; margin-top: -10px;">
                            Diperbarui 1 hari lalu</p>
            ...
            <div class="col-md-4 mb-4">
                <div class="card" style="width: 26.25rem; border: none; border-radius: 20px">
                    <img class="imagess" src="{{ asset('images/property/property5.png') }}" class="card-img-fluid"
                        alt="property5">
                    <div class="card-body">
                        <h5 class="card-price"
                            style="font-weight: bold; font-family: Montserrat, sans-serif; font-size: 24px">Rp 700 Jt - 1 M
                        </h5>
                        <h2 class="card-tittle"
                            style="font-weight: 600; font-family: Montserrat, sans-serif; font-size: 20px">Cendana Valley
                        </h2>
                        <h3 class="card-text"
                            style="font-weight: 600; font-family: Montserrat, sans-serif; font-size: 12px">By Siti Aisyah
                        </h3>
                        <p class="card-text" style="font-family: Montserrat, sans-serif; font-size: 12px; opacity: 0.7;">
                            Tangerang, Banten</p>
                        <p class="card-text" style="font-family: Montserrat, sans-serif; font-size: 12px;">2-3 KT, LT
                            80-150 m², LB 60-110 m²</p>
                        <p class="card-text"
                            style="font-family: Montserrat, sans-serif; font-size: 12px; opacity: 0.7; margin-top: -10px;">
                            Diperbarui 4 hari lalu</p>
            ...
            <div class="col-md-4 mb-4">
                <div class="card" style="width: 26.25rem; border: none; border-radius: 20px">
                    <img class="imagess" src="{{ asset('images/property/property6.png') }}" class="card-img-fluid"
                        alt="property6">
                    <div class="card-body">
                        <h5 class="card-price"
                            style="font-weight: bold; font-family: Montserrat, sans-serif; font-size: 24px">Rp 1 M - 1,8 M
                        </h5>
                        <h2 class="card-tittle"
                            style="font-weight: 600; font-family: Montserrat, sans-serif; font-size: 20px">Orchard Hill
                            Residence</h2>
                        <h3 class="card-text"
                            style="font-weight: 600; font-family: Montserrat, sans-serif; font-size: 12px">By Ridwan
                            Kurniawan</h3>
                        <p class="card-text" style="font-family: Montserrat, sans-serif; font-size: 12px; opacity: 0.7;">
                            Sawangan, Kota Depok</p>
                        <p class="card-text" style="font-family: Montserrat, sans-serif; font-size: 12px;">3-5 KT, LT
                            110-200 m², LB 90-150 m²</p>
                        <p class="card-text"
                            style="font-family: Montserrat, sans-serif; font-size: 12px; opacity: 0.7; margin-top: -10px;">
                            Diperbarui 1 hari lalu</p>
            ...
            <div class="col-md-4 mb-4">
                <div class="card" style="width: 26.25rem; border: none; border-radius: 20px">
                    <img class="imagess" src="{{ asset('images/property/property7.png') }}" class="card-img-fluid"
                        alt="property7">
                    <div class="card-body">
                        <h5 class="card-price"
                            style="font-weight: bold; font-family: Montserrat, sans-serif; font-size: 24px">Rp 1,1 M - 1,9
                            M</h5>
                        <h2 class="card-tittle"
                            style="font-weight: 600; font-family: Montserrat, sans-serif; font-size: 20px">Grand Mahkota
                            Estate</h2>
                        <h3 class="card-text"
                            style="font-weight: 600; font-family: Montserrat, sans-serif; font-size: 12px">By Nina Hartati
                        </h3>
                        <p class="card-text" style="font-family: Montserrat, sans-serif; font-size: 12px; opacity: 0.7;">
                            Bogor, Jawa Barat</p>
                        <p class="card-text" style="font-family: Montserrat, sans-serif; font-size: 12px;">3-4 KT, LT
                            130-210 m², LB 100-140 m²</p>
                        <p class="card-text"
                            style="font-family: Montserrat, sans-serif; font-size: 12px; opacity: 0.7; margin-top: -10px;">
                            Diperbarui 5 hari lalu</p>
            ...
            <div class="col-md-4 mb-4">
                <div class="card" style="width: 26.25rem; border: none; border-radius: 20px">
                    <img class="imagess" src="{{ asset('images/property/property8.png') }}" class="card-img-fluid"
                        alt="property8">
                    <div class="card-body">
                        <h5 class="card-price"
                            style="font-weight: bold; font-family: Montserrat, sans-serif; font-size: 24px">Rp 850 Jt - 1,2
                            M</h5>
                        <h2 class="card-tittle"
                            style="font-weight: 600; font-family: Montserrat, sans-serif; font-size: 20px">Palm View
                            Residence</h2>
                        <h3 class="card-text"
                            style="font-weight: 600; font-family: Montserrat, sans-serif; font-size: 12px">By Agus Santoso
                        </h3>
                        <p class="card-text" style="font-family: Montserrat, sans-serif; font-size: 12px; opacity: 0.7;">
                            Bandung, Jawa Barat</p>
                        <p class="card-text" style="font-family: Montserrat, sans-serif; font-size: 12px;">2-4 KT, LT
                            90-160 m², LB 70-120 m²</p>
                        <p class="card-text"
                            style="font-family: Montserrat, sans-serif; font-size: 12px; opacity: 0.7; margin-top: -10px;">
                            Diperbarui 3 hari lalu</p>
            ...
            <div class="col-md-4 mb-4">
                <div class="card" style="width: 26.25rem; border: none; border-radius: 20px">
                    <img class="imagess" src="{{ asset('images/property/property9.png') }}" class="card-img-fluid"
                        alt="property9">
                    <div class="card-body">
                        <h5 class="card-price"
                            style="font-weight: bold; font-family: Montserrat, sans-serif; font-size: 24px">Rp 1,3 M - 2,5
                            M</h5>
                        <h2 class="card-tittle"
                            style="font-weight: 600; font-family: Montserrat, sans-serif; font-size: 20px">Vista Green
                            Hills</h2>
                        <h3 class="card-text"
                            style="font-weight: 600; font-family: Montserrat, sans-serif; font-size: 12px">By Rita Sari
                        </h3>
                        <p class="card-text" style="font-family: Montserrat, sans-serif; font-size: 12px; opacity: 0.7;">
                            Bogor, Jawa Barat</p>
                        <p class="card-text" style="font-family: Montserrat, sans-serif; font-size: 12px;">4-5 KT, LT
                            140-300 m², LB 120-180 m²</p>
                        <p class="card-text"
                            style="font-family: Montserrat, sans-serif; font-size: 12px; opacity: 0.7; margin-top: -10px;">
                            Diperbarui 6 hari lalu</p>
