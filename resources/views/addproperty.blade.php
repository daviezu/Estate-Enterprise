                    ...
                    <div class="col">
                        ...
                        <form action="{{ route('agent.property.create') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="container mt-4">
                                <div class="mb-3 ">
                                    <label for="pictures" class="form-label">Gambar <span class="text-secondary">( Masukkan 6 Gambar )</span></label>
                                    <input class="form-control border-2 rounded" 
                                    name="pictures[]"style="border-color: #44D7B5;" type="file"
                                        id="pictures" multiple required>
                                    @error("pictures")
