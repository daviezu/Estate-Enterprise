            ...
            <div class="card table-responsive mt-3">
                ...
                <table class="table table-borderless">
                    ...
                    <tbody>
                        ...
                        <tr class="row-2">
                            <td>
                                <img src="{{ asset('images/property/property2.png') }}" alt="Property Image"
                                    class="img-fluid-property2">
                            </td>
                            <td class="txt-judulrow1">Dijual Rumah Mewah dengan Halaman Luas & Strategis</td>
                            <td class="txt-deskripsirow1">Dijual Rumah Mewah dengan Halaman Luas dan Strategis....</td>
                            <td class="txt-lokasirow1">Jakarta Barat, DKI Jakarta</td>
                        ...
                        <tr class="row-3">
                            <td>
                                <img src="{{ asset('images/property/property3.png') }}" alt="Property Image"
                                    class="img-fluid-property3">
                            </td>
                            <td class="txt-judulrow1">Dijual Rumah Mewah dengan Halaman Luas & Strategis</td>
                            <td class="txt-deskripsirow1">Dijual Rumah Mewah dengan Halaman Luas dan Strategis....</td>
                            <td class="txt-lokasirow1">Jakarta Barat, DKI Jakarta</td>
                        ...
                        <tr class="row-4">
                            <td>
                                <img src="{{ asset('images/property/property4.png') }}" alt="Property Image"
                                    class="img-fluid-property4">
                            </td>
                            <td class="txt-judulrow1">Dijual Rumah Mewah dengan Halaman Luas & Strategis</td>
                            <td class="txt-deskripsirow1">Dijual Rumah Mewah dengan Halaman Luas dan Strategis....</td>
                            <td class="txt-lokasirow1">Jakarta Barat, DKI Jakarta</td>
                        ...
                        <tr class="row-5">
                            <td>
                                <img src="{{ asset('images/property/property10.png') }}" alt="Property Image"
                                    class="img-fluid-property10">
                            </td>
                            <td class="txt-judulrow1">Dijual Rumah Mewah dengan Halaman Luas & Strategis</td>
                            <td class="txt-deskripsirow1">Dijual Rumah Mewah dengan Halaman Luas dan Strategis....</td>
                            <td class="txt-lokasirow1">Jakarta Barat, DKI Jakarta</td>
                        ...
                        <tr class="row-6">
                            <td>
                                <img src="{{ asset('images/property/property6.png') }}" alt="Property Image"
                                    class="img-fluid-property6">
                            </td>
                            <td class="txt-judulrow1">Dijual Rumah Mewah dengan Halaman Luas & Strategis</td>
                            <td class="txt-deskripsirow1">Dijual Rumah Mewah dengan Halaman Luas dan Strategis....</td>
                            <td class="txt-lokasirow1">Jakarta Barat, DKI Jakarta</td>
