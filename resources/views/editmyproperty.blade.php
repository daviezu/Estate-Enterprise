                    ...
                    <form action="{{ route('agent.property.edit', $property->property_id) }}" method="POST">
                        ...
                        <div class="container mt-4">
                            ...
                            <div class="mb-3 ">
                                ...
                                <input type="text" class="form-control rounded border-2" style="border-color: #44D7B5;"
                                    name="property_owner" id="property_owner" placeholder="Ex: Wilson Sumanto" value="{{$property->property_owner}}">
                            </div>
                            <div class="mb-3 ">
                                ...
                                <input type="number" class="form-control rounded border-2" style="border-color: #44D7B5;"
                                    name="price" id="price" placeholder="Ex: Rp 1.500.000 (dalam rupiah)" value="{{$property->price}}">
                            </div>
                            <div class="mb-3 ">
                            ...
                            <div class="mb-3 ">
                                ...
                                <input type="text" class="form-control rounded border-2" style="border-color: #44D7B5;"
                                    name="address" id="address" placeholder="Ex: Jakarta barat" value="{{$property->address}}">
                            </div>
                            <div class="mb-3 ">
                                ...
                                <input type="url" class="form-control rounded border-2" style="border-color: #44D7B5;"
                                    ...
                                    placeholder="Ex: https://www.google.com/maps/embed?pb=!1m18!..." value="{{$property->location_link}}">
                            </div>
                            <div class="mb-3 ">
                                <label for="building_size" class="form-label">Building Size</label>
                                <input type="number" class="form-control rounded border-2" style="border-color: #44D7B5;"
                                    name="building_size" id="building_size" min="0" placeholder="Ex: 1000 (dalam satuan m2)" value="{{$property->building_size}}">
                            </div>
                            <div class="mb-3 ">
                                <label for="land_size" class="form-label">Land Size</label>
                                <input type="number" class="form-control rounded border-2" style="border-color: #44D7B5;"
                                    name="land_size" id="land_size" min="0" placeholder="Ex: 840 (dalam satuan m2)" value="{{$property->land_size}}">
                            </div>
                            <div class="mb-3 ">
                                <label for="certificate" class="form-label">Certificate</label>
                                <input type="text" class="form-control rounded border-2" style="border-color: #44D7B5;"
                                    name="certificate" id="certificate" placeholder="Ex: SHM/Freehold" value="{{$property->certificate}}">
                            </div>
                            <div class="mb-3 ">
                                <label for="bedroom" class="form-label">Bedroom</label>
                                <input type="number" class="form-control rounded border-2" style="border-color: #44D7B5;"
                                    name="bedroom" id="bedroom" min="0" placeholder="Ex: 6" value="{{$property->bedroom}}">
                            </div>
                            <div class="mb-3 ">
                                <label for="bathroom" class="form-label">Bathroom</label>
                                <input type="number" class="form-control rounded border-2" style="border-color: #44D7B5;"
                                    name="bathroom" id="bathroom" min="0" placeholder="Ex: 6" value="{{$property->bathroom}}">
                            </div>
                            <div class="mb-5 ">
                                <label for="carport" class="form-label">Carport</label>
                                <input type="number" class="form-control rounded border-2" style="border-color: #44D7B5;"
                                    name="carport" id="carport" min="0" placeholder="Ex: 4" value="{{$property->carport}}">
                            </div>
                            <div class="mb-5 ">
                                <button class="btn text-light" style="background-color: #44D7B5" type="submit">Ubah</button>
                            </div>
                        </div>
                    </form>
                </div>
