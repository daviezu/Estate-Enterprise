...
@section('content')
    ...
    <div class="container-fluid position-relative w-100 mt-5" style="padding: 6rem 0; z-index:100; overflow:hidden;">

        {{-- Assset  --}}
    
      
        <div class=" position-absolute w-100 " style="top:0; right:0;  z-index:1; ">
            
            <img src="{{ asset('images/Triangle.png') }}" alt="triangleasset"
                style="width: 15%; position: absolute; left: -15px; top: -4px; z-index: 5;">
            <img src="{{ asset('images/Triangle.png') }}" alt="triangleasset"
                style="width: 20%; position: absolute; left: -150px; top: 230px; z-index: 5;">
            <img src="{{ asset('images/Triangle.png') }}" alt="triangleasset"
                style="width: 15%; position: absolute; left: 550px; top: 40px; z-index: 5;">
            <img src="{{ asset('images/Triangle.png') }}" alt="triangleasset"
                style="width: 15%; position: absolute; left: 550px; top: 550px; z-index: 5;">
            
    
        </div>
    
        <!-- Card Login -->
        <div class="h-100 py-2 px-0 card-login position-relative z-2 " >
            <div class="card shadow px-0 py-5 d-flex flex-column justify-content-center align-items-center w-100"
                ...
                <form action="{{ route('login.post') }}" method="POST" class="w-100 d-flex flex-column align-items-center gap-3 ">
                    ...
                    <div class="d-flex  w-100 px-5" >
                        ...
                        <div class="d-flex flex-column gap-2">
                            ...
                            <a href="#" class="text-decoration-none register-small"
        ...
        <div class="position-absolute px-0 me-0" style="top:0; right:0; z-index:10; ">
            ...
            <div class="content-section me-0 ">
                <h2 class="text-center mb-4 font-content"
                    style="margin-top: -45px;  color: #43D3B2; font-weight: bold; ">Belum
                    punya akun?</h2>
