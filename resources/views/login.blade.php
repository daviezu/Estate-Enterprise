...
@section('content')
    ...
    <div class="col-md-6 d-flex justify-content-start align-items-start" style="margin: 200px 700px;">
        <div class="card shadow p-4 d-flex flex-column justify-content-center align-items-center"
            style="width: 410px; height: 355px; border-radius: 20px; font-family: Montserrat, sans-serif; border: none; z-index: 2; position: relative;">
            ...
            <form class="w-100 d-flex flex-column align-items-center">
                ...
                <div class="d-flex justify-content-between align-items-center mb-4" style="width: 283px;">
                    ...
                    <a href="#" class="text-decoration-none"
                        style="margin-top: -10px; color: #44D7B5; font-size: 12px;">Lupa Password?</a>
                </div>
        ...
        <div class="content-section">
            ...
            <div class="d-flex justify-content-end" style="width: 283px; margin-top: 50px;">
                <a href="{{ route('register.index') }}">
                    ...
                    <button type="submit" class="btn btn-primary"
                        style="width: 106px; height: 32px; background-color: black;  border-color:#44D7B5; border-radius: 5px; font-size: 12px; font-weight: bold;">Register</button>
            </div>
            </a>
